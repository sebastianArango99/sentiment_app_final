...
model_2 = load_model("C:/models/sentimiento_app/best_model.h5")#tf.keras.models.load_model("C:/models/modelo_lstm")
model_1= tf.saved_model.load("C:/models/sentimiento_app/modelo_bert/")
...
with open('C:/models/sentimiento_app/tokenizer.pickle', 'rb') as handle:
